@testset "CoSaMP" begin
    ...
    @testset "Residual convergence" begin
        Random.seed!(202)
        n, p, k = 40, 100, 5
        A, x_true, b = gaussian_sensing(n, p, k)

        x_recovered = CoSaMP(A, b; sparsity=k, tol=1e-8)
